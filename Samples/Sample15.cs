...
namespace EPPlusSamples
{
    class Sample15
    {
        ...
        private static void VBASample3(DirectoryInfo outputDir)
        {
            ...
            //Note: For security reasons you should never mix external data and code(to avoid code injections!), especially not on a web server. 
            //If you decide to do that anyway, be very careful with the validation of the data.
